...
pub static GEM_NAME: LazyLock<HashMap<u32, &'static str>> = LazyLock::new(|| {
    HashMap::from([
		(10,"[ERROR]test gem 1"),
		(11,""),
		(12,""),
		...
		(30300,"Ash of War: Buckler Parry"),
		(30400,"Ash of War: Parry"),
		...
		(40700,"Ashes of War: Invisible Arrow"),
