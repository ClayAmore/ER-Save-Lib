...
pub static ACCESSORY_NAME: LazyLock<HashMap<u32, &'static str>> = LazyLock::new(|| {
    HashMap::from([
		(1,""),
		(2,""),
		(100,"Petition for Help"),
		(101,"Broken Finger Stalker Contract"),
		...
		(6098,""),
		(6099,""),
		(6100,"[ERROR]Entwining Umbilical Cord"),
		(6101,""),
		(6102,""),
		(6103,""),
		(6104,""),
